...
const FOM_LINKS = [
  {
    ...
    description: "facebook.com/FeastMarikinaOfficial",
    icon: <FacebookIcon />,
    bg: "bg-blue-600",
  },
  {
    label: "Instagram",
    href: "https://www.instagram.com/feastmarikinaofficial",
    description: "@feastmarikinaofficial",
    icon: <InstagramIcon />,
    bg: "bg-gradient-to-br from-pink-500 via-red-500 to-yellow-400",
  },
  {
    label: "Email us",
    href: "mailto:thefeastmarikina@gmail.com",
    description: "thefeastmarikina@gmail.com",
    icon: <MailIcon />,
    bg: "bg-gray-600",
  },
];
